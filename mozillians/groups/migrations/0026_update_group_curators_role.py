...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # assign Steward role to all the curators
        from mozillians.groups.models import GroupRole
        for item in orm.GroupMembership.objects.all():
            if item.userprofile == item.group.curator:
                item.role = GroupRole.STEWARD
                item.save()
    ...
    models = {
        ...
        u'groups.groupalias': {
            ...
            'alias': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'aliases'", 'to': u"orm['groups.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'groups.skillalias': {
            ...
            'alias': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'aliases'", 'to': u"orm['groups.Skill']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'url': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': "'name'", 'unique_with': '()', 'blank': 'True'})
        },
