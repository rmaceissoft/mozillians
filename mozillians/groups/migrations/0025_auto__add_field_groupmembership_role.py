...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupMembership.role'
        db.add_column(u'groups_groupmembership', 'role',
                      self.gf('django.db.models.fields.CharField')(default='m', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupMembership.role'
        db.delete_column(u'groups_groupmembership', 'role')
